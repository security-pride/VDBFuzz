...
# 获取测试模块的日志器
logger = logging.getLogger('vdb_fuzzer.test.test_scroll_order_by_test_scroll_duplicated_values')
...
TEST_NAME = "test_scroll_order_by.test_scroll_duplicated_values"
VDB_TYPE = "qdrant"
...
class TestScrollOrderBytestScrollDuplicatedValues:
    """自动生成的VDB模糊测试类 - test_scroll_order_by.test_scroll_duplicated_values"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "test_scroll_order_by.test_scroll_duplicated_values"
    ...
    'payload': {
    'integer_array': self.mutator.generate_float_array(dimension=4, normalized=True),
},
},
    {
    'id': 2,
    ...
    'must_not': [
    {
    'has_id': self.mutator.generate_float_array(dimension=4, normalized=True),
},
],
},
    'with_payload': True,
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - test_scroll_order_by.test_scroll_duplicated_values')
    ...
    # 实例化测试类并运行测试
    test = TestScrollOrderBytestScrollDuplicatedValues()
    test.run_tests()
