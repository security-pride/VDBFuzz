...
# 获取测试模块的日志器
logger = logging.getLogger('vdb_fuzzer.test.test_collection_test_double_insert_with_same_uuid')
...
TEST_NAME = "test_collection.test_double_insert_with_same_uuid"
VDB_TYPE = "weaviate"
...
class TestCollectiontestDoubleInsertWithSameUuid:
    """自动生成的VDB模糊测试类 - test_collection.test_double_insert_with_same_uuid"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "test_collection.test_double_insert_with_same_uuid"
    ...
    'class': 'Test_collectionpy_test_double_insert_with_same_uuid_1',
}
    ...
    'id': 'b7273672-deda-48b7-b8db-aaa38acf3270',
}
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - test_collection.test_double_insert_with_same_uuid')
    ...
    # 实例化测试类并运行测试
    test = TestCollectiontestDoubleInsertWithSameUuid()
    test.run_tests()
