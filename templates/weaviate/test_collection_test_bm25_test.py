...
# 获取测试模块的日志器
logger = logging.getLogger('vdb_fuzzer.test.test_collection_test_bm25')
...
TEST_NAME = "test_collection.test_bm25"
VDB_TYPE = "weaviate"
...
class TestCollectiontestBm25:
    """自动生成的VDB模糊测试类 - test_collection.test_bm25"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "test_collection.test_bm25"
    ...
    'class': 'Test_collectionpy_test_bm25_1',
    'properties': [
    {
    'name': 'Name',
    'dataType': [
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - test_collection.test_bm25')
