...
# 获取测试模块的日志器
logger = logging.getLogger('vdb_fuzzer.test.test_collection_test_query_properties')
...
TEST_NAME = "test_collection.test_query_properties"
VDB_TYPE = "weaviate"
...
class TestCollectiontestQueryProperties:
    """自动生成的VDB模糊测试类 - test_collection.test_query_properties"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "test_collection.test_query_properties"
    ...
    'class': 'Test_collectionpy_test_query_properties_1',
    'properties': [
    {
    'name': 'Name',
    'dataType': [
    ...
    'id': 'c120cb38-3781-4cbe-829f-3f763475c763',
}
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - test_collection.test_query_properties')
    ...
    # 实例化测试类并运行测试
    test = TestCollectiontestQueryProperties()
    test.run_tests()
