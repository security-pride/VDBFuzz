...
# 获取测试模块的日志器
logger = logging.getLogger('vdb_fuzzer.test.test_collection_geo_test_geo_props_filter')
...
TEST_NAME = "test_collection_geo.test_geo_props_filter"
VDB_TYPE = "weaviate"
...
class TestCollectionGeotestGeoPropsFilter:
    """自动生成的VDB模糊测试类 - test_collection_geo.test_geo_props_filter"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "test_collection_geo.test_geo_props_filter"
    ...
    'class': 'Test_collection_geopy_test_geo_props_filter_1',
    'properties': [
    {
    'name': 'geo',
    'dataType': [
    ...
    'id': '0db7e54b-0fbb-453b-9ab6-353b28808bf0',
}
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - test_collection_geo.test_geo_props_filter')
    ...
    # 实例化测试类并运行测试
    test = TestCollectionGeotestGeoPropsFilter()
    test.run_tests()
