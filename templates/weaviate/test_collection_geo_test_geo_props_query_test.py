...
# 获取测试模块的日志器
logger = logging.getLogger('vdb_fuzzer.test.test_collection_geo_test_geo_props_query')
...
TEST_NAME = "test_collection_geo.test_geo_props_query"
VDB_TYPE = "weaviate"
...
class TestCollectionGeotestGeoPropsQuery:
    """自动生成的VDB模糊测试类 - test_collection_geo.test_geo_props_query"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "test_collection_geo.test_geo_props_query"
    ...
    'class': 'Test_collection_geopy_test_geo_props_query_1',
    'properties': [
    {
    'name': 'geo',
    'dataType': [
    ...
    'id': 'c8b15ce6-9543-4540-8402-93b6ae9debe3',
}
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - test_collection_geo.test_geo_props_query')
    ...
    # 实例化测试类并运行测试
    test = TestCollectionGeotestGeoPropsQuery()
    test.run_tests()
