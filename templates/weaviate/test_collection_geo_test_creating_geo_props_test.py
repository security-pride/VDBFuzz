...
# 获取测试模块的日志器
logger = logging.getLogger('vdb_fuzzer.test.test_collection_geo_test_creating_geo_props')
...
TEST_NAME = "test_collection_geo.test_creating_geo_props"
VDB_TYPE = "weaviate"
...
class TestCollectionGeotestCreatingGeoProps:
    """自动生成的VDB模糊测试类 - test_collection_geo.test_creating_geo_props"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "test_collection_geo.test_creating_geo_props"
    ...
    'class': 'Test_collection_geopy_test_creating_geo_props_1',
    'properties': [
    {
    'name': 'geo',
    'dataType': [
    ...
    'id': 'f4ad7a7c-6c83-4a68-955f-6fd1d19e98fa',
}
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - test_collection_geo.test_creating_geo_props')
    ...
    # 实例化测试类并运行测试
    test = TestCollectionGeotestCreatingGeoProps()
    test.run_tests()
