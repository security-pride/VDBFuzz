...
# 获取测试模块的日志器
logger = logging.getLogger('vdb_fuzzer.test.test_client_debug_test_get_object_single_node')
...
TEST_NAME = "test_client_debug.test_get_object_single_node"
VDB_TYPE = "weaviate"
...
class TestClientDebugtestGetObjectSingleNode:
    """自动生成的VDB模糊测试类 - test_client_debug.test_get_object_single_node"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "test_client_debug.test_get_object_single_node"
    ...
    'class': 'Test_client_debugpy_test_get_object_single_node_1',
    'properties': [
    {
    'name': 'name',
    'dataType': [
    ...
    'id': '63e0d7ab-d25d-4bb6-82f6-6f48bd2b4a5d',
}
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - test_client_debug.test_get_object_single_node')
    ...
    # 实例化测试类并运行测试
    test = TestClientDebugtestGetObjectSingleNode()
    test.run_tests()
