...
# 获取测试模块的日志器
logger = logging.getLogger('vdb_fuzzer.test.test_collection_test_sort')
...
TEST_NAME = "test_collection.test_sort"
VDB_TYPE = "weaviate"
...
class TestCollectiontestSort:
    """自动生成的VDB模糊测试类 - test_collection.test_sort"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "test_collection.test_sort"
    ...
    'class': 'Test_collectionpy_test_sortsort0expected0_1',
    'properties': [
    {
    'name': 'age',
    'dataType': [
    ...
    'id': '806827e0-2b31-43ca-9269-24fa95a221f1',
}
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - test_collection.test_sort')
