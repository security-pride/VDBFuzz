...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-False-10]_1752747862_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-False-10]_1752747862.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueTrueFalse101752747862Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-False-10]_1752747862.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-False-10]_1752747862.json"
    ...
    'RequestId': '2db2b978-62f8-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_24_10_663453ZdzpJcCI',
    'schema': {
    'autoId': False,
    ...
    'data': [
    {
    '8': 0.7916968162678264,
    '84': 0.1382754723818278,
    '98': 0.1443835922247303,
    '95': 0.5141691774766682,
    '36': 0.27625856756897227,
    '16': 0.7676805665014824,
    '51': 0.4752177562092261,
    '21': 0.11683945860263467,
    '72': 0.8476190560966477,
    '89': 0.7559831639516348,
    '19': 0.9831651058664318,
    '74': 0.4718683595433949,
    '3': 0.4228135216705736,
    '68': 0.24341513454124175,
    '45': 0.04111031413890809,
    '126': 0.042114939145589614,
    '4': 0.0911183939902227,
    '49': 0.7995019631690876,
    '87': 0.3578741291468228,
    '119': 0.2139881344114094,
    '33': 0.5610007026640893,
    '46': 0.9606416816091936,
    '100': 0.3035815059132775,
    '64': 0.3374424926301489,
    '59': 0.5270102694900071,
    '26': 0.8148946326556668,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-False-10]_1752747862.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueTrueFalse101752747862Json()
    test.run_tests()
