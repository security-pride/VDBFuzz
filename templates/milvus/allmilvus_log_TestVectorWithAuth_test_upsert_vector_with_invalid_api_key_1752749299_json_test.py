...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestVectorWithAuth_test_upsert_vector_with_invalid_api_key_1752749299_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestVectorWithAuth_test_upsert_vector_with_invalid_api_key_1752749299.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestvectorwithauthTestUpsertVectorWithInvalidApiKey1752749299Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestVectorWithAuth_test_upsert_vector_with_invalid_api_key_1752749299.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestVectorWithAuth_test_upsert_vector_with_invalid_api_key_1752749299.json"
    ...
    'RequestId': '8bd7d38c-62fb-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_48_17_102355fySKkaSW',
    'dimension': 128,
    'params': {
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestVectorWithAuth_test_upsert_vector_with_invalid_api_key_1752749299.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestvectorwithauthTestUpsertVectorWithInvalidApiKey1752749299Json()
    test.run_tests()
