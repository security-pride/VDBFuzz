...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-True-10]_1752747882_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-True-10]_1752747882.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueFalseTrue101752747882Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-True-10]_1752747882.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-True-10]_1752747882.json"
    ...
    'RequestId': '3a2788d2-62f8-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_24_31_561710JZxOazBT',
    'schema': {
    'autoId': True,
    ...
    'data': [
    {
    '32': 0.6439556529790899,
    '124': 0.2058685347405046,
    '74': 0.9476488466097187,
    '94': 0.3630699315962873,
    '84': 0.2501173414292478,
    '77': 0.12512259545970505,
    '55': 0.18914409665243237,
    '51': 0.8001605305580484,
    '108': 0.3548270256544772,
    '34': 0.5981172502091546,
    '54': 0.849275616184134,
    '80': 0.3941636735251147,
    '89': 0.963671566378603,
    '39': 0.800861149419873,
    '28': 0.46008776790381245,
    '88': 0.8771913778955239,
    '86': 0.6002617473039088,
    '52': 0.3648338661691074,
    '38': 0.37820345089003593,
    '87': 0.49179641462958623,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-True-10]_1752747882.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueFalseTrue101752747882Json()
    test.run_tests()
