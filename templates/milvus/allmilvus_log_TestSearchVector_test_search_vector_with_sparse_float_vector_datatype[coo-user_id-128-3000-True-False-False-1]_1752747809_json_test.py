...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-False-1]_1752747809_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-False-1]_1752747809.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueFalseFalse11752747809Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-False-1]_1752747809.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-False-1]_1752747809.json"
    ...
    'RequestId': '12f9c64e-62f8-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_23_25_831355BFpeOhaK',
    'schema': {
    'autoId': False,
    ...
    'data': [
    {
    '44': 0.5200046777570354,
    '103': 0.7574863061009255,
    '32': 0.49299381432916745,
    '0': 0.3884105877633548,
    '93': 0.22852107516675835,
    '102': 0.9606231285905893,
    '120': 0.44014768949591454,
    '76': 0.23095980799683935,
    '26': 0.30396795322852577,
    '57': 0.2729167521512703,
    '24': 0.9601833036183898,
    '78': 0.4360571870717673,
    '67': 0.775552998105368,
    '25': 0.1303799201022109,
    '66': 0.6524838560792912,
    '104': 0.23591339853724458,
    '18': 0.2677564008540839,
    '77': 0.32140389617011156,
    '41': 0.9775921622153299,
    '28': 0.41609234982331367,
    '65': 0.18084088075216476,
    '89': 0.7831376648096293,
    '126': 0.13404939835426066,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-False-1]_1752747809.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueFalseFalse11752747809Json()
    test.run_tests()
