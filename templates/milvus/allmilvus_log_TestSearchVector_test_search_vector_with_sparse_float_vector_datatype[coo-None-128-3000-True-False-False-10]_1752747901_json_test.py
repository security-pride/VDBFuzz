...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-False-10]_1752747901_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-False-10]_1752747901.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueFalseFalse101752747901Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-False-10]_1752747901.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-False-10]_1752747901.json"
    ...
    'RequestId': '45638188-62f8-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_24_50_409478hoDTLmgC',
    'schema': {
    'autoId': False,
    ...
    'data': [
    {
    '49': 0.6043642258271724,
    '92': 0.8982706541552505,
    '51': 0.8330297225256704,
    '52': 0.3736258174631877,
    '50': 0.8575951438212037,
    '70': 0.8832868478059599,
    '46': 0.28863880558961297,
    '97': 0.6888253673912063,
    '127': 0.2918547094049869,
    '73': 0.6870422989144742,
    '21': 0.09432131059613869,
    '47': 0.5993233237350086,
    '36': 0.33037760113203185,
    '117': 0.3584304796837575,
    '18': 0.8089597031831169,
    '25': 0.8554222655223775,
    '100': 0.27143008016337855,
    '59': 0.713277338712272,
    '111': 0.46769527151167833,
    '95': 0.6472159104300339,
    '75': 0.14308934984460775,
    '116': 0.8883283092367943,
    '76': 0.4132454705463663,
    '41': 0.7336071071325507,
    '38': 0.24364184320204108,
    '42': 0.8535729474103017,
    '15': 0.8004027549127373,
    '12': 0.15556593323173684,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-False-10]_1752747901.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueFalseFalse101752747901Json()
    test.run_tests()
