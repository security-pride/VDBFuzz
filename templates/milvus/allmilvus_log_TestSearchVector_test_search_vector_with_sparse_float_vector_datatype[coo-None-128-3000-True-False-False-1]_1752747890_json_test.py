...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-False-1]_1752747890_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-False-1]_1752747890.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueFalseFalse11752747890Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-False-1]_1752747890.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-False-1]_1752747890.json"
    ...
    'RequestId': '42a6bc3a-62f8-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_24_45_818045mWWkdeRk',
    'schema': {
    'autoId': False,
    ...
    'data': [
    {
    '69': 0.8564766036833761,
    '16': 0.08956928736293479,
    '11': 0.15192393108154845,
    '24': 0.12587352952033048,
    '6': 0.6947196733992218,
    '51': 0.7330529858080278,
    '57': 0.10969704955995119,
    '14': 0.8086087496636113,
    '84': 0.7827941443862158,
    '83': 0.4885155573025475,
    '121': 0.4987168998097029,
    '108': 0.5252587915336693,
    '109': 0.33102119410551234,
    '32': 0.4961308787798492,
    '55': 0.12343972134906123,
    '99': 0.721070373272256,
    '31': 0.8524453214145454,
    '19': 0.9483556630704308,
    '7': 0.6382028100761674,
    '54': 0.4752552437752372,
    '73': 0.45465135935048784,
    '70': 0.4142314568583394,
    '3': 0.07945591175002242,
    '28': 0.8967405779997792,
    '30': 0.7367047384908418,
    '116': 0.12617591168022702,
    '10': 0.24840099269939275,
    '89': 0.43707159745762225,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-False-1]_1752747890.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueFalseFalse11752747890Json()
    test.run_tests()
