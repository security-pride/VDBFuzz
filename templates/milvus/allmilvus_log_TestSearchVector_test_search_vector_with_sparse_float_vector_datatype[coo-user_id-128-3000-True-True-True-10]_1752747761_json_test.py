...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-True-10]_1752747761_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-True-10]_1752747761.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueTrueTrue101752747761Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-True-10]_1752747761.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-True-10]_1752747761.json"
    ...
    'RequestId': 'f19c65ec-62f7-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_22_29_853731BhbgqWfl',
    'schema': {
    'autoId': True,
    ...
    'data': [
    {
    '100': 0.880219191766258,
    '113': 0.050802126124333546,
    '91': 0.8635672502237169,
    '38': 0.40630250095483655,
    '41': 0.08563243976445634,
    '4': 0.9207868572140072,
    '103': 0.25678675029958997,
    '75': 0.3488616606601558,
    '28': 0.19149569345248618,
    '66': 0.5349563570490625,
    '111': 0.8863946326649169,
    '53': 0.24702251705897038,
    '40': 0.8321782762571706,
    '61': 0.20153341995601615,
    '27': 0.6295840288140184,
    '96': 0.9246885480697523,
    '35': 0.2340059144365476,
    '121': 0.8530726903179137,
    '64': 0.6672228260551416,
    '123': 0.8260268975614263,
    '5': 0.6457192199916202,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-True-10]_1752747761.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueTrueTrue101752747761Json()
    test.run_tests()
