...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-False-1]_1752747850_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-False-1]_1752747850.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueTrueFalse11752747850Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-False-1]_1752747850.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-False-1]_1752747850.json"
    ...
    'RequestId': '2aa36d9a-62f8-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_24_05_531180SnSZldLf',
    'schema': {
    'autoId': False,
    ...
    'data': [
    {
    '14': 0.5930005718474242,
    '43': 0.7891486253920094,
    '82': 0.6518104653800894,
    '111': 0.520948141331143,
    '59': 0.9910300418684139,
    '100': 0.5831430531368298,
    '0': 0.663716689512856,
    '7': 0.658451078137111,
    '93': 0.6574278335004387,
    '89': 0.8929438530420326,
    '11': 0.3084250770310639,
    '71': 0.2874677551046373,
    '40': 0.9008006780527419,
    '81': 0.5254930053469031,
    '10': 0.6609280014268619,
    '104': 0.747858642236474,
    '80': 0.23601781473190264,
    '77': 0.7014921752420462,
    '94': 0.33623676044399686,
    '95': 0.8618525519689006,
    '18': 0.2739760134445681,
    '124': 0.6036921187573784,
    '6': 0.27398990912619736,
    '98': 0.11741036107081315,
    '112': 0.5484148032938505,
    '32': 0.25623198136440994,
    '85': 0.8184075868641288,
    '105': 0.8945443579100196,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-False-1]_1752747850.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueTrueFalse11752747850Json()
    test.run_tests()
