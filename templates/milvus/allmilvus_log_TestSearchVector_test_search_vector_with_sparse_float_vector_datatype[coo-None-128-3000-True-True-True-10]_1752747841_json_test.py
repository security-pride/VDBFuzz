...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-True-10]_1752747841_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-True-10]_1752747841.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueTrueTrue101752747841Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-True-10]_1752747841.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-True-10]_1752747841.json"
    ...
    'RequestId': '213d69c2-62f8-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_23_49_761523DihtmCkr',
    'schema': {
    'autoId': True,
    ...
    'data': [
    {
    '16': 0.46526093036808824,
    '24': 0.16415091046642682,
    '83': 0.3109488951806759,
    '109': 0.6204617418648456,
    '57': 0.5527238800071149,
    '5': 0.2982913525888323,
    '85': 0.4595374926782616,
    '10': 0.7178451866498518,
    '12': 0.09208466652123914,
    '125': 0.4611815317172896,
    '86': 0.020856116376606226,
    '28': 0.5067326593052348,
    '34': 0.8197467883784414,
    '13': 0.6410747888466198,
    '45': 0.2418675620333396,
    '77': 0.30574826336200067,
    '40': 0.4384308783928672,
    '8': 0.8525722712257381,
    '17': 0.5069712650642779,
    '56': 0.6273969158644498,
    '110': 0.7302603790156891,
    '54': 0.48097903284687804,
    '88': 0.09227002777680815,
    '43': 0.14760180973569248,
    '99': 0.3373730985291631,
    '112': 0.5086737265594862,
    '50': 0.43678248249105256,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-True-10]_1752747841.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueTrueTrue101752747841Json()
    test.run_tests()
