...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestInsertVectorNegative_test_insert_entities_with_none_no_nullable_field_1752747400_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestInsertVectorNegative_test_insert_entities_with_none_no_nullable_field_1752747400.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestinsertvectornegativeTestInsertEntitiesWithNoneNoNullableField1752747400Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestInsertVectorNegative_test_insert_entities_with_none_no_nullable_field_1752747400.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestInsertVectorNegative_test_insert_entities_with_none_no_nullable_field_1752747400.json"
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestInsertVectorNegative_test_insert_entities_with_none_no_nullable_field_1752747400.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestinsertvectornegativeTestInsertEntitiesWithNoneNoNullableField1752747400Json()
    test.run_tests()
