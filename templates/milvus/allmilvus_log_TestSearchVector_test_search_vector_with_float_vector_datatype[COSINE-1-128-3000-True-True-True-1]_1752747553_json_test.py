...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_float_vector_datatype[COSINE-1-128-3000-True-True-True-1]_1752747553_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_float_vector_datatype[COSINE-1-128-3000-True-True-True-1]_1752747553.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithFloatVectorDatatypeCosine11283000TrueTrueTrue11752747553Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_float_vector_datatype[COSINE-1-128-3000-True-True-True-1]_1752747553.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_float_vector_datatype[COSINE-1-128-3000-True-True-True-1]_1752747553.json"
    ...
    'RequestId': '78f1dc4e-62f7-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_19_07_409838IhmaYHUi',
    'schema': {
    'autoId': True,
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_float_vector_datatype[COSINE-1-128-3000-True-True-True-1]_1752747553.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithFloatVectorDatatypeCosine11283000TrueTrueTrue11752747553Json()
    test.run_tests()
