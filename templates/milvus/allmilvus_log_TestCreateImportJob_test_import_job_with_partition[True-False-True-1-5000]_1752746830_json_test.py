...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestCreateImportJob_test_import_job_with_partition[True-False-True-1-5000]_1752746830_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestCreateImportJob_test_import_job_with_partition[True-False-True-1-5000]_1752746830.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestcreateimportjobTestImportJobWithPartitionTrueFalseTrue150001752746830Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestCreateImportJob_test_import_job_with_partition[True-False-True-1-5000]_1752746830.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestCreateImportJob_test_import_job_with_partition[True-False-True-1-5000]_1752746830.json"
    ...
    'RequestId': 'c9ed9efa-62f5-11f0-b651-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_07_04_283862woCttJge',
    'schema': {
    'autoId': True,
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestCreateImportJob_test_import_job_with_partition[True-False-True-1-5000]_1752746830.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestcreateimportjobTestImportJobWithPartitionTrueFalseTrue150001752746830Json()
    test.run_tests()
