...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-True-1]_1752747871_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-True-1]_1752747871.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueFalseTrue11752747871Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-True-1]_1752747871.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-True-1]_1752747871.json"
    ...
    'RequestId': '3757ad44-62f8-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_24_26_845319xFxSswDN',
    'schema': {
    'autoId': True,
    ...
    'data': [
    {
    '29': 0.17478121855117035,
    '120': 0.12518601681765962,
    '34': 0.6648445164365923,
    '77': 0.6991854143127963,
    '5': 0.3919472906213086,
    '54': 0.3015684876351954,
    '45': 0.18287225233139293,
    '92': 0.07285550971482813,
    '9': 0.6361276777961608,
    '118': 0.6155338698216238,
    '56': 0.5960988076770614,
    '83': 0.1871846477868142,
    '90': 0.5454410940974146,
    '37': 0.6467968736390871,
    '126': 0.17697029003578357,
    '44': 0.8819059163983821,
    '53': 0.14638831582852496,
    '96': 0.4643404964939859,
    '42': 0.05767976421080334,
    '6': 0.6605474275090988,
    '23': 0.5129661647274608,
    '113': 0.13461440308116135,
    '122': 0.9077919540812643,
    '70': 0.9096893816795747,
    '64': 0.633077884823204,
    '20': 0.41700537647067015,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-False-True-1]_1752747871.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueFalseTrue11752747871Json()
    test.run_tests()
