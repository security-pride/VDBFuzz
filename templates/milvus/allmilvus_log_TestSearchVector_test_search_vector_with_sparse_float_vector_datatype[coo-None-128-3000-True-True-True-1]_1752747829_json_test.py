...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-True-1]_1752747829_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-True-1]_1752747829.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueTrueTrue11752747829Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-True-1]_1752747829.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-True-1]_1752747829.json"
    ...
    'RequestId': '1e6661ea-62f8-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_23_44_998757KAEUMguq',
    'schema': {
    'autoId': True,
    ...
    'data': [
    {
    '22': 0.9678128928498027,
    '50': 0.6798295272524555,
    '85': 0.8418167903003035,
    '4': 0.9451719769847716,
    '100': 0.07743786012068743,
    '40': 0.7966306887761213,
    '28': 0.8242478077899598,
    '107': 0.8009421959137788,
    '11': 0.21033631466255176,
    '70': 0.6829555365624869,
    '41': 0.7114745785878307,
    '37': 0.8034371005022076,
    '92': 0.5300675457809524,
    '61': 0.7499674262686497,
    '42': 0.38105121813361764,
    '8': 0.7851495441747056,
    '66': 0.8871615474184207,
    '27': 0.4807090350750114,
    '122': 0.9377591007682279,
    '16': 0.9929290598457323,
    '65': 0.7131322007611849,
    '93': 0.3155713986326253,
    '58': 0.1463471528197514,
    '5': 0.1595224756711301,
    '63': 0.5266676770581749,
    '116': 0.17072102435820824,
    '112': 0.5846413238524403,
    '43': 0.782254953778387,
    '24': 0.727838823986108,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-None-128-3000-True-True-True-1]_1752747829.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooNone1283000TrueTrueTrue11752747829Json()
    test.run_tests()
