...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-False-10]_1752747782_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-False-10]_1752747782.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueTrueFalse101752747782Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-False-10]_1752747782.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-False-10]_1752747782.json"
    ...
    'RequestId': 'fe05159a-62f7-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_22_50_672353IaKdMeqY',
    'schema': {
    'autoId': False,
    ...
    'data': [
    {
    '92': 0.20809783489576694,
    '48': 0.14754400131122725,
    '95': 0.7047661350706506,
    '83': 0.6552135109592326,
    '51': 0.9726111785762201,
    '122': 0.24060645718685392,
    '112': 0.4830305335572084,
    '29': 0.9065033212123146,
    '27': 0.4721962704959033,
    '70': 0.654765973403641,
    '4': 0.3635756603485134,
    '75': 0.5007041699227196,
    '67': 0.37935463989858287,
    '125': 0.7762752883623116,
    '68': 0.8363053966322097,
    '24': 0.4152174998191185,
    '69': 0.9525329753854528,
    '54': 0.5725902411209991,
    '5': 0.5365264974956284,
    '119': 0.1524624569334726,
    '120': 0.9550220650725586,
    '104': 0.4347732126333367,
    '39': 0.8235589762456569,
    '72': 0.2520028257506276,
    '80': 0.6943170899574117,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-False-10]_1752747782.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueTrueFalse101752747782Json()
    test.run_tests()
