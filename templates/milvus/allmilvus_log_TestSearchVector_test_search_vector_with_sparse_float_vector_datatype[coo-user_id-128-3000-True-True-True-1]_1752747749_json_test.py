...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-True-1]_1752747749_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-True-1]_1752747749.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueTrueTrue11752747749Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-True-1]_1752747749.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-True-1]_1752747749.json"
    ...
    'RequestId': 'ef0391a2-62f7-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_22_25_497786NhGnFXeB',
    'schema': {
    'autoId': True,
    ...
    'data': [
    {
    '126': 0.9084836179610629,
    '6': 0.9445801742066422,
    '93': 0.6719305749118946,
    '110': 0.01813632567293122,
    '29': 0.4747466584050646,
    '125': 0.7100543012936539,
    '58': 0.95933577843667,
    '37': 0.8514957549232887,
    '114': 0.42563969817439185,
    '2': 0.888755188061031,
    '28': 0.8249168861412098,
    '59': 0.30431544417681544,
    '127': 0.09999952869502493,
    '119': 0.2472666253844651,
    '85': 0.44867990052390017,
    '79': 0.8976885543431593,
    '8': 0.9517182958609756,
    '117': 0.7490685278952494,
    '42': 0.6555257595729675,
    '118': 0.20087663212158913,
    '61': 0.1235758077955117,
    '106': 0.8370258766207269,
    '36': 0.2081185795725614,
    '46': 0.33532998181945317,
    '107': 0.22737773040031495,
    '73': 0.5488249839982509,
    '53': 0.2505814150298842,
    '32': 0.3638168592381976,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-True-1]_1752747749.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueTrueTrue11752747749Json()
    test.run_tests()
