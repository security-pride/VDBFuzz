...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-False-1]_1752747770_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-False-1]_1752747770.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueTrueFalse11752747770Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-False-1]_1752747770.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-False-1]_1752747770.json"
    ...
    'RequestId': 'fb540194-62f7-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_22_46_158438VioTeJNX',
    'schema': {
    'autoId': False,
    ...
    'data': [
    {
    '27': 0.4818032127398725,
    '20': 0.518983771434493,
    '91': 0.1796635839116264,
    '62': 0.8063859899694811,
    '90': 0.8653138466497811,
    '122': 0.11743848940182067,
    '110': 0.3891022333084796,
    '82': 0.16443141252564752,
    '55': 0.470730983379405,
    '4': 0.8296915584555684,
    '32': 0.2867137475259288,
    '98': 0.2984273206324416,
    '64': 0.49687566790475857,
    '14': 0.4345909853140223,
    '38': 0.9830233286820397,
    '61': 0.41392137122986894,
    '28': 0.34713149248400355,
    '104': 0.8278622551275396,
    '57': 0.41643490793999793,
    '45': 0.8737976056883703,
    '46': 0.7440211811540676,
    '75': 0.3339395109609087,
    '117': 0.152312218713192,
    '86': 0.06889010015919028,
    '12': 0.8740792802275671,
    '69': 0.7381879406916655,
    '72': 0.4488477880793935,
    '16': 0.229347947365392,
    '125': 0.13747294026385393,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-True-False-1]_1752747770.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueTrueFalse11752747770Json()
    test.run_tests()
