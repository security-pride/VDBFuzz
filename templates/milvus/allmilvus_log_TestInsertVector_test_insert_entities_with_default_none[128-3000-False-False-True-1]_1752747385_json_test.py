...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestInsertVector_test_insert_entities_with_default_none[128-3000-False-False-True-1]_1752747385_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestInsertVector_test_insert_entities_with_default_none[128-3000-False-False-True-1]_1752747385.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestinsertvectorTestInsertEntitiesWithDefaultNone1283000FalseFalseTrue11752747385Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestInsertVector_test_insert_entities_with_default_none[128-3000-False-False-True-1]_1752747385.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestInsertVector_test_insert_entities_with_default_none[128-3000-False-False-True-1]_1752747385.json"
    ...
    'RequestId': '15477a3c-62f7-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_16_20_201485OOhfXktC',
    'schema': {
    'autoId': True,
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestInsertVector_test_insert_entities_with_default_none[128-3000-False-False-True-1]_1752747385.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestinsertvectorTestInsertEntitiesWithDefaultNone1283000FalseFalseTrue11752747385Json()
    test.run_tests()
