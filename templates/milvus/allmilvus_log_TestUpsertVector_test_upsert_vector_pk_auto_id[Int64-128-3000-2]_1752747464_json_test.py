...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestUpsertVector_test_upsert_vector_pk_auto_id[Int64-128-3000-2]_1752747464_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestUpsertVector_test_upsert_vector_pk_auto_id[Int64-128-3000-2]_1752747464.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestupsertvectorTestUpsertVectorPkAutoIdInt64128300021752747464Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestUpsertVector_test_upsert_vector_pk_auto_id[Int64-128-3000-2]_1752747464.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestUpsertVector_test_upsert_vector_pk_auto_id[Int64-128-3000-2]_1752747464.json"
    ...
    'RequestId': '45c84772-62f7-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_17_41_574963HivyEHeh',
    'schema': {
    'autoId': True,
    'fields': [
    {
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestUpsertVector_test_upsert_vector_pk_auto_id[Int64-128-3000-2]_1752747464.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestupsertvectorTestUpsertVectorPkAutoIdInt64128300021752747464Json()
    test.run_tests()
