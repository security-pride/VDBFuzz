...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-False-10]_1752747821_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-False-10]_1752747821.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueFalseFalse101752747821Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-False-10]_1752747821.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-False-10]_1752747821.json"
    ...
    'RequestId': '15aa81e4-62f8-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_23_30_343312ytQawLKo',
    'schema': {
    'autoId': False,
    ...
    'data': [
    {
    '89': 0.6678838004252344,
    '66': 0.547338885126468,
    '21': 0.2675403919540944,
    '59': 0.9233493702778415,
    '38': 0.6188259533186647,
    '97': 0.542244400027351,
    '115': 0.4441950498059929,
    '54': 0.2560712815505092,
    '82': 0.35702258046369584,
    '111': 0.3793128640001121,
    '91': 0.10096016878343239,
    '98': 0.297688747223108,
    '30': 0.12360255227595962,
    '41': 0.3841129414203772,
    '13': 0.2852302560676092,
    '102': 0.03586786722959734,
    '6': 0.015352573029001504,
    '110': 0.27775262342657114,
    '90': 0.6478139623035927,
    '123': 0.17226476054631668,
    '126': 0.1776463479559386,
    '68': 0.7198963126812815,
    '12': 0.8447879775981711,
    '63': 0.8719389651149628,
    '36': 0.5656455564422459,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-False-10]_1752747821.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueFalseFalse101752747821Json()
    test.run_tests()
