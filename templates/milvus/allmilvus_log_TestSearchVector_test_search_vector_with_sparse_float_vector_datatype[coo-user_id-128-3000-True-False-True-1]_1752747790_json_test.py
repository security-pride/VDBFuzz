...
# 获取测试模块的日志器
logger = logging.getLogger('vdbfuzz.test.allmilvus_log_TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-True-1]_1752747790_json')
logger.info("日志文件将输出到: " + log_file)

# 全局变量
TARGET_URL = ""
OUTPUT_DIR = "templates_milvus"
TEST_NAME = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-True-1]_1752747790.json"
VDB_TYPE = "milvus"
...
class AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueFalseTrue11752747790Json:
    """自动生成的VDB模糊测试类 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-True-1]_1752747790.json"""
    
    def __init__(self):
        """初始化测试类"""
        self.test_name = "allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-True-1]_1752747790.json"
    ...
    'RequestId': '079203ca-62f8-11f0-85c3-0242ac11000b',
    'Request-Timeout': '120',
}
        
        # 原始请求内容
        original_content = {
    'collectionName': 'test_collection_2025_07_17_18_23_06_697545TlqvRHRA',
    'schema': {
    'autoId': True,
    ...
    'data': [
    {
    '32': 0.2316929221780949,
    '58': 0.6645485759727764,
    '22': 0.9940939348649266,
    '106': 0.6187663636736562,
    '46': 0.8277744974467244,
    '9': 0.38292860405131235,
    '49': 0.7353659269249189,
    '113': 0.16968930846229324,
    '6': 0.18084724824544696,
    '53': 0.9414266612762209,
    '92': 0.31219718305835753,
    '119': 0.21195785968435454,
    '79': 0.23601571683446854,
    '68': 0.9278253893651665,
    '108': 0.6962460744571362,
    '36': 0.39834324006735344,
    '109': 0.19172647829860034,
    '14': 0.8711228240029123,
    '70': 0.6274243832503897,
    '112': 0.7609577902392467,
    '84': 0.5712914444059126,
    '65': 0.06449886547449324,
    '54': 0.17706102225429754,
    '33': 0.9143130348904207,
    '40': 0.8285113906497846,
    '12': 0.5425428803465392,
},
],
...
if __name__ == "__main__":
    # 解析命令行参数
    parser = argparse.ArgumentParser(description='VDB模糊测试 - allmilvus_log.TestSearchVector_test_search_vector_with_sparse_float_vector_datatype[coo-user_id-128-3000-True-False-True-1]_1752747790.json')
    ...
    # 实例化测试类并运行测试
    test = AllmilvusLogtestsearchvectorTestSearchVectorWithSparseFloatVectorDatatypeCooUserId1283000TrueFalseTrue11752747790Json()
    test.run_tests()
